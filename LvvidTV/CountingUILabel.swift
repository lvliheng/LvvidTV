//
//  CountingUILabel.swift
//  MyTVForIOS
//
//  Created by lvvi on 2020/3/17.
...
class CountingUILabel: UILabel {
    ...
    func count(fromValue: Float, to toValue: Float, withDuration duration: TimeInterval,
               andAnimationType animationType: CounterAnimationType, andCounterType counterType: CounterType) {
        ...
        timer = Timer.scheduledTimer(timeInterval: 0.01, target: self,
                                     selector: #selector(CountingUILabel.updateValue), userInfo: nil, repeats: true)
    }
